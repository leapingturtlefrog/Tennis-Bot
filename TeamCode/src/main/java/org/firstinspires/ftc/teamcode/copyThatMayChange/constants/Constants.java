...
public class Constants {
    ...
    public static final String TFOD_MODEL_FILE = //"/sdcard/FIRST/tflitemodels/detect2_metadata.tflite";
    ...
    public static float confidenceLevel1 = 0.01f, confidenceLevel2 = 0.01f;

    //

    public static int exposure1 = 1, exposure2 = 1; //says 1-1000, but after 40 it is basically all white
    public static int gain1 = 100, gain2 = 150; //0-255 for this webcam
